...
import { Flag, Flashlight, Mailbox, MessageCircle, MessageCircleDashed, MessageSquare, Phone, SendHorizonal, User } from 'lucide-react';
...
const ContactPage = () => {
  ...
  const handlesubmit =(e)=>{
    ...
    if(!validatePhone(formData.phone)){
        setPhoneError('Please enter a valid 10-digit moble number');
        return;
    }
    ...
    const whatsappUrl = `https://wa.me/6398553009?text=${whatsappMessage}`;
                        ...
                        <form className={contactStyles.formElements} onSubmit={handlesubmit}>
                            ...
                            <div className={contactStyles.formGrid}>
                                <div className={contactStyles.formGroup}>
                                    ...
                                    <input type="text" name='name' value={formData.name} onChange={handleChange} required className={`${contactStyles.input} ${contactStyles.colors.purple.focus} ${contactStyles.colors.purple.hover}`}
                                ...
                                <div className={contactStyles.formGroup}>
                                    ...
                                    <input type="email" name='email' value={formData.email} onChange={handleChange} required className={`${contactStyles.input} ${contactStyles.colors.blue.focus} ${contactStyles.colors.blue.hover}`}
                            ...
                            <div className={contactStyles.formGroup}>
                                ...
                                <textarea name="message" value={formData.message} onChange={handleChange} required rows='5' className={`${contactStyles.textarea} ${contactStyles.colors.blue.focus}`} placeholder="Tell us abou your project inquiry..."></textarea>
                            </div>
                            <button type='submit' disabled={!isFormValid || isSubmitting} className={`${contactStyles.submitButton} ${isFormValid && !isSubmitting ? contactStyles.submitButtonEnabled : contactStyles.submitButtonDisabled}`}>
                                {isSubmitting ? (
                                    <>

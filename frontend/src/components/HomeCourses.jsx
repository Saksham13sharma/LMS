...
const HomeCourses = () => {
    ...
    const handleSetRating = async (e, courseId, rating) => {
        e.stopPropagation();
        if(!isSignedIn){
            toast('please sign in to submit this rating...',{icon:"⭐"} )
            return;
        }
  ...
  return (
    <div className={homeCoursesStyles.container}>
        <div className={homeCoursesStyles.mainContainer}>
            ...
            {loading ? (
                <div className="p-6 text-center">Loading courses...
                </div>
            ) : error ? (
                            ...
                            return(
                                <div key={course.id} onClick={()=>handleCourseClick(course.id)} className={homeCoursesStyles.courseCard}>
                                    ...
                                    <div className={homeCoursesStyles.courseInfo}>
                                        ...
                                        <div className={homeCoursesStyles.ratingContainer}>{renderInteractiveStars(course)}
                                        </div>

    ...
    <section className={testimonialStyles.section}>
        <div className={testimonialStyles.container}>
            <div className={testimonialStyles.badge}>
                ...
                <h3 className={testimonialStyles.title}>
                    <span className={testimonialStyles.titleGradient}>
                        Voices of Success
                    </span>
                </h3>
                <p className={testimonialStyles.subtitle}>Discover how our learners tranformed thier carrers with hands-on project and export mentorship</p>
            </div>
            <div className={testimonialStyles.grid}>
                {testimonials.map((t,i)=>(
                    ...
                    onMouseLeave={()=> onMouseLeave(cardsRef.current[i])} key={t.id} className={testimonialStyles.cardWrapper}>
                        ...
                        <article ref={(el)=>(cardsRef.current[i]=el)} className={testimonialStyles.card} 
                            ...
                            <div className={testimonialStyles.content}>
                                <div className={testimonialStyles.avatarContainer}>
                                    <div className={testimonialStyles.avatarWrapper}>
                                        <img src={t.avatar} alt="avtars" 
                                        className={testimonialStyles.avatarImage} loading='lazy'/>
                                    </div>

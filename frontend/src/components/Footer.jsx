            ...
            <div className={footerStyles.grid}>
                <div className={footerStyles.brandSection}>
                    <div className={footerStyles.brandTransform}>
                        ...
                        <p className={footerStyles.brandDescription}>Transform your learning journey with interactive courses and cutting-edge educational technology for modern learners.</p>
                    </div>
                </div>
                ...
                <div className={footerStyles.socialContainer}>
                    ...
                    <div className={footerStyles.designCredit}>
                        <div className={footerStyles.designCreditContainer}>
                            ...
                            <p className={footerStyles.designCreditLink}>Designed by{" "}
                                <a href={contactInfo.website} target='_blamk' className={footerStyles.designCreditLink}>

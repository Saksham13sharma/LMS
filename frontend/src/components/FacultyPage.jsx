      ...
      <div className={facultyStyles.header}>
        <div className={facultyStyles.headerContent}>
            ...
            <p className={facultyStyles.subtitle}>
                Learn from industry exports and academic pioneers dedicated to your success
            </p>
        </div>
      </div>
                    ...
                    >
                        <div className={facultyStyles.teacherCard}>
                            ...
                            <div className={facultyStyles.socialContainer}>
                                <a href={`mailto:${teacher.email}`} className={`${facultyStyles.socialIcon} ${facultyStyles.socialIconEmail}`} title={`Email ${teacher.name}`}>
                                    <Mail className={facultyStyles.socialIconSvg}/>
                                </a>
                                <a href={teacher.linkedin} target='_blank' className={`${facultyStyles.socialIcon} ${facultyStyles.socialIconLinkedin}`}>
                                    <Linkedin className={facultyStyles.socialIconSvg}/>
                                </a>
                                <a href={teacher.instagram} target='_blank' className={`${facultyStyles.socialIcon} ${facultyStyles.socialIconInstagram}`}>

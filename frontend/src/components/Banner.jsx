        ...
        <div className={bannerStyles.grid}>
          <div className={bannerStyles.leftContent}>
            <span className={bannerStyles.badge}>
              <Sparkle className={bannerStyles.badgeIcon} /> New Features Available
            </span>
            ...
            <p className={bannerStyles.description}>
              Create beautiful, responsive web application with our powerful tools and components. Start building your next project today.
            </p>
            {/* features */}
            <div className={bannerStyles.featuresGrid}>
              {features.map((feature,i)=>(
                <div key={i} className={bannerStyles.featureItem}>
                  ...
                  <span className={bannerStyles.featureText}>{feature.text}</span>
                </div>
              ))}
            </div>
      ...
      {showVideo && (
        <div className={bannerStyles.videoModal.overlay}>
          <div className={bannerStyles.videoModal.container}>
            <iframe src={video} className={bannerStyles.videoModal.iframe} title='Demo Video' allow="autoplay; encrypted-media" allowFullScreen ></iframe>

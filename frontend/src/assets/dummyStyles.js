...
export const homeCoursesStyles = {
  ...
  imageContainer: "relative rounded-t-2xl xl:rounded-t-2xl overflow-hidden aspect-video bg-gray-200",
  courseImage: "w-full h-full object-cover transition-transform duration-300 group-hover:scale-105 group-hover:shadow-[0_8px_32px_0_rgba(99,102,241,0.18)]",
  
  // Course Info
  courseInfo: "mt-4 px-3 bg-white/70 backdrop-blur-md rounded-b-xl -translate-y-3 sm:-translate-y-5 shadow-lg space-y-2 py-3",
...
export const navbarStyles = {
  ...
  // Desktop Navigation
  desktopNav: "hidden lg:flex items-center flex-1 max-w-2xl",
  desktopNavContainer: "flex items-center flex-nowrap gap-1 bg-white/80 backdrop-blur-sm rounded-2xl p-1 shadow-sm border border-gray-200 overflow-x-auto",
  desktopNavItem: "group relative px-3 py-2 rounded-xl transition-all duration-300 flex items-center gap-1 flex-nowrap min-w-fit",
  desktopNavItemActive: "bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-600 shadow-md",
  desktopNavIcon: "text-gray-600 transition-colors duration-300 group-hover:text-blue-600 w-4 h-4",
  desktopNavText: "text-xs font-medium text-gray-700 group-hover:text-blue-600 whitespace-nowrap",

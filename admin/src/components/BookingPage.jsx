...
import { BadgeIndianRupee, BookKey, GraduationCap, Search, User, BookOpen } from 'lucide-react';
    ...
    <div className={bookingsStyles.pageContainer}>
      <div className={bookingsStyles.contentContainer}>
        <div className={bookingsStyles.headerContainer}>
            ...
            <p className={bookingsStyles.headerSubtitle}>Manage and view all student course purchases</p>
        </div>
        ...
        <div className={bookingsStyles.searchContainer}>
            <div className={bookingsStyles.searchInputContainer}>
                ...
                <input type="text" placeholder='Search by student, course, or teacher...' value={searchTerm} onChange={(e)=>setSearchTerm(e.target.value)} className={bookingsStyles.searchInput}/>
            </div>
        </div>
        ...
        {!loading && bookings.length === 0 && !error && (
            <div className={bookingsStyles.emptyState}>
                <div className={bookingsStyles.emptyContainer}>
                    ...
                    <h3 className={bookingsStyles.emptyTitle}>No booking found</h3>
                    <p className={bookingsStyles.emptyText}>Try adjusting your search or filter to find what you're looking for.</p>
                </div>
            </div>
        )}
      </div>

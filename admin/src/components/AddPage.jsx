...
const AddPage = () => {
  ...
  const [currentChapter, setCurrentChapter] = useState({
    ...
    // to toggle the lecture 
  const toggleLecture = (index, event) => {
  ...
  return (
    <div className={addPageStyles.pageContainer}>
        ...
        <div className={addPageStyles.contentContainer}>
            ...
            <p className={addPageStyles.headerSubtitle}>Craft an exceptional learning experience eith our intutive course creation platform </p>
        </div>
                ...
                <div key={lecture.id} className={addPageStyles.lectureCard}>
                  <div className={addPageStyles.lectureHeader}>
                    <div className={addPageStyles.lectureContent}>
                      <button
                        type="button"
                        onClick={(e) => toggleLecture(lectureIndex, e)}
            ...
            <div className={addPageStyles.modal}>
              ...
              <div className={addPageStyles.modalContent}>
                <div>
                  ...
                  <input type="text" name="title" value={currentLecture.title} onChange={handleLectureChange} placeholder='e.g., Introduction to React' className={addPageStyles.input}/>
                </div>
                ...
                {currentLecture.chapters.length > 0 && (
                  <div>
                    <label className={addPageStyles.inputLabel}>Chapters in this lecture:
                    </label>
                ...
                <div className="flex gap-2 sm:gap-3 pt-2">
                  <button type='button' onClick={addLecture} className={`${addPageStyles.modalButton} ${addPageStyles.modalButtonPrimary}`}>
                    Add Lecture
                  </button>
                  <button type='button' onClick={()=>setShowLectureForm(false)} className={`${addPageStyles.modalButton} ${addPageStyles.modalButtonSecondary}`}>
                    Cancel
                  </button>
                </div>
              </div>

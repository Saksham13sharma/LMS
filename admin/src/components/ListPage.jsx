...
const ListPage = () => {
  ...
  // filter courses (by name, insructor)
        ...
        <div className={listStyles.pageContainer}>
            ...
            <div className={listStyles.contentContainer}>
                <div className={listStyles.headerContainer}>
                    ...
                    <p className={listStyles.headerSubtitle}>Manage and browse your coyrse - clean, light and elegant.</p>
                </div>
                ...
                <div className={listStyles.searchContainer}>
                    <div className={listStyles.searchInputContainer}>
                        ...
                        <input type="text" placeholder='Search courses, instructors, or categories...' value={searchTerm} onChange={(e)=> setSearchTerm(e.target.value)} className={listStyles.searchInput} 
                        />
                    </div>
                </div>
                ...
                <div className={listStyles.courseList}>
                    ...
                    <div key={course.id} className={listStyles.courseCard}>
                        ...
                        <div className={listStyles.courseHeader}>
                            ...
                            <div className={listStyles.actionButtons}>
                                ...
                                >
                                <Edit className={listStyles.actionIcon} />
                                </button>
                    ...
                    {loading && filteredCourses.length === 0 && (
                        <div className={listStyles.emptyState}>
                            ...
                            <p className={listStyles.emptyIcon}>No courses found matching your search</p>

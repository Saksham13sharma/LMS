...
// we also need to check for the booking as a user has aready enrolled in that course or not
...
export const checkBooking = async (req,res)=>{
    ...
    console.error("chechBooking error:", err);
    return res.status(500).json({ success: false, message: "Server error" });
  }
}
